...
// checks if the UpdateInflightTransaction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateInflightTransaction{}

// UpdateInflightTransaction struct for UpdateInflightTransaction
type UpdateInflightTransaction struct {
...
type _UpdateInflightTransaction UpdateInflightTransaction
...
func NewUpdateInflightTransaction(amount int32, id string, allowOverdraft bool, infligt bool, source string, destination string, reference string, currency string, description string, status string, hash string, groupIds NullableString, createdAt string, scheduledFor string) *UpdateInflightTransaction {
	this := UpdateInflightTransaction{}
	this.Amount = amount
	this.Id = id
...
func (o UpdateInflightTransaction) MarshalJSON() ([]byte, error) {
...
func (o UpdateInflightTransaction) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateInflightTransaction) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateInflightTransaction := _UpdateInflightTransaction{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateInflightTransaction)

	if err != nil {
		return err
	}

	*o = UpdateInflightTransaction(varUpdateInflightTransaction)

	return err
}

type NullableUpdateInflightTransaction struct {
	value *UpdateInflightTransaction
	isSet bool
}

func (v NullableUpdateInflightTransaction) Get() *UpdateInflightTransaction {
	return v.value
}

func (v *NullableUpdateInflightTransaction) Set(val *UpdateInflightTransaction) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateInflightTransaction) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateInflightTransaction) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateInflightTransaction(val *UpdateInflightTransaction) *NullableUpdateInflightTransaction {
	return &NullableUpdateInflightTransaction{value: val, isSet: true}
}

func (v NullableUpdateInflightTransaction) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateInflightTransaction) UnmarshalJSON(src []byte) error {
	v.isSet = true
