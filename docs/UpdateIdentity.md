...
`func NewUpdateIdentity(message string, ) *UpdateIdentity`
...
`func (o *UpdateIdentity) GetMessage() string`

GetMessage returns the Message field if non-nil, zero value otherwise.

### GetMessageOk

`func (o *UpdateIdentity) GetMessageOk() (*string, bool)`
...
`func (o *UpdateIdentity) SetMessage(v string)`
