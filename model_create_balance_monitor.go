...
// checks if the CreateBalanceMonitor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateBalanceMonitor{}

// CreateBalanceMonitor struct for CreateBalanceMonitor
...
type _CreateBalanceMonitor CreateBalanceMonitor
...
func (o CreateBalanceMonitor) MarshalJSON() ([]byte, error) {
...
func (o CreateBalanceMonitor) ToMap() (map[string]interface{}, error) {
...
func (o *CreateBalanceMonitor) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateBalanceMonitor := _CreateBalanceMonitor{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateBalanceMonitor)

	if err != nil {
		return err
	}

	*o = CreateBalanceMonitor(varCreateBalanceMonitor)

	return err
}

type NullableCreateBalanceMonitor struct {
	value *CreateBalanceMonitor
	isSet bool
}

func (v NullableCreateBalanceMonitor) Get() *CreateBalanceMonitor {
	return v.value
}

func (v *NullableCreateBalanceMonitor) Set(val *CreateBalanceMonitor) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateBalanceMonitor) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateBalanceMonitor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateBalanceMonitor(val *CreateBalanceMonitor) *NullableCreateBalanceMonitor {
	return &NullableCreateBalanceMonitor{value: val, isSet: true}
}

func (v NullableCreateBalanceMonitor) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateBalanceMonitor) UnmarshalJSON(src []byte) error {
	v.isSet = true
